...
import TipoContenedorCreador from './TipoContenedorCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipoContenedorAction';
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip
                  ...
                  onClick={onOpenAddTipoContenedor}>
                  <IconButton
...
const TipoContenedor = (props) => {
  ...
  const [tipoContenedorSeleccionado, setTipoContenedorSeleccionado] =
    useState(0);
  ...
  }, [dispatch, page, rowsPerPage, debouncedName, orderByToSend]); //eslint-disable-line
  ...
  const onOpenEditTipoContenedor = (id) => {
    setTipoContenedorSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewTipoContenedor = (id) => {
    setTipoContenedorSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteTipoContenedor = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El Tipo de Contenedor?',
  ...
  const onOpenAddTipoContenedor = () => {
    setTipoContenedorSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoContenedor={onOpenAddTipoContenedor}
                          ...
                          <TableCell
                            ...
                            {permisos.indexOf('Modificar') >= 0 && (
                              <Tooltip
                                ...
                                <EditIcon
                                  onClick={() =>
                                    onOpenEditTipoContenedor(row.id)
                                  }
                            ...
                            {permisos.indexOf('Listar') >= 0 && (
                              <Tooltip title={<IntlMessages id='boton.ver' />}>
                                <VisibilityIcon
                                  onClick={() =>
                                    onOpenViewTipoContenedor(row.id)
                                  }
      ...
      {showForm ? (
        <TipoContenedorCreador
          showForm={showForm}
          tipoContenedor={tipoContenedorSeleccionado}
          accion={accion}
