...
import TipoAlertaCreador from './TipoAlertaCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipoAlertaAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip
                  title='Crear Tipo de Alerta'
                  onClick={onOpenAddTipoAlerta}>
                  <IconButton
...
const TipoAlerta = (props) => {
  ...
  const [tipoAlertaSeleccionado, setTipoAlertaSeleccionado] =
    useState(0);
  ...
  const onOpenEditTipoAlerta = (id) => {
    setTipoAlertaSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewTipoAlerta = (id) => {
    setTipoAlertaSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteTipoAlerta = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El tipo de Alerta?',
  ...
  const onOpenAddTipoAlerta = () => {
    setTipoAlertaSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoAlerta={onOpenAddTipoAlerta}
      ...
      {showForm ? (
        <TipoAlertaCreador
          showForm={showForm}
          tipoAlerta={tipoAlertaSeleccionado}
          accion={accion}
