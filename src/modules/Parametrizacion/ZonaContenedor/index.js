...
import ZonaContenedorCreador from './ZonaContenedorCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/ZonaContenedorAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip
                  title='Crear Zona Contenedor'
                  onClick={onOpenAddZonaContenedor}>
                  <IconButton
...
const ZonaContenedor = (props) => {
  ...
  const [zonaContenedorSeleccionado, setZonaContenedorSeleccionado] =
    useState(0);
  ...
  const onOpenEditZonaContenedor = (id) => {
    setZonaContenedorSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewZonaContenedor = (id) => {
    setZonaContenedorSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteZonaContenedor = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar La Zona de Contenedor?',
  ...
  const onOpenAddZonaContenedor = () => {
    setZonaContenedorSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddZonaContenedor={onOpenAddZonaContenedor}
                          ...
                          <TableCell
                            ...
                            {permisos.indexOf('Modificar') >= 0 && (
                              <Tooltip
                                ...
                                <EditIcon
                                  onClick={() =>
                                    onOpenEditZonaContenedor(row.id)
                                  }
                            ...
                            {permisos.indexOf('Listar') >= 0 && (
                              <Tooltip title={<IntlMessages id='boton.ver' />}>
                                <VisibilityIcon
                                  onClick={() =>
                                    onOpenViewZonaContenedor(row.id)
                                  }
      ...
      {showForm ? (
        <ZonaContenedorCreador
          showForm={showForm}
          zonaContenedor={zonaContenedorSeleccionado}
          accion={accion}
