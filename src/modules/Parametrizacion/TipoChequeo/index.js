...
import TipoChequeoCreador from './TipoChequeoCreador';
import {
  onGetColeccion,
  onDelete,
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip
                  title='Crear Tipo de Chequeo'
                  onClick={onOpenAddTipoChequeo}>
                  <IconButton
...
const TipoChequeo = (props) => {
  ...
  const [tipoChequeoSeleccionado, setTipoChequeoSeleccionado] =
    useState(0);
  ...
  const onOpenEditTipoChequeo = (id) => {
    setTipoChequeoSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewTipoChequeo = (id) => {
    setTipoChequeoSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteTipoChequeo = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El Tipo de Chequeo?',
  ...
  const onOpenAddTipoChequeo = () => {
    setTipoChequeoSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            onOpenAddTipoChequeo={onOpenAddTipoChequeo}
      ...
      {showForm ? (
        <TipoChequeoCreador
          showForm={showForm}
          tipoChequeo={tipoChequeoSeleccionado}
          accion={accion}
