...
import FormatoInspeccionForm from './FormatoInspeccionForm';
...
const FormatoInspeccionCreador = (props) => {
  const {
    formatoInspeccion,
    handleOnClose,
    accion,
  ...
  selectedRow = useSelector(
    ({formatoInspeccionReducer}) => formatoInspeccionReducer.selectedRow,
  );
  ...
  useEffect(() => {
    if ((accion === 'editar') | (accion === 'ver')) {
      dispatch(onShow(formatoInspeccion));
    }
  }, [accion, dispatch, formatoInspeccion]);
...
export default FormatoInspeccionCreador;
