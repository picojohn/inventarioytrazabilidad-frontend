        ...
        <Box py={5} px={{xs: 5, lg: 8, xl: 10}}>
          ...
          <Box px={{md: 5, lg: 8, xl: 10}}>
            ...
            <MySelectField 
                ...
                required 
            />
            <Box style={{marginTop: 10}} className={classes.inputs_2}>
              <MyRadioField
                label='Evento Manual'
                name='indicativo_evento_manual'
                required
                disabled={disabled}
              ...
              <MySelectField
                label='Clase Evento'
                name='indicativo_clase_evento'
                required
                disabled={disabled}
                options={CLASES_EVENTOS}
              />
              <MyRadioField
                label='Estado'
                name='estado'
