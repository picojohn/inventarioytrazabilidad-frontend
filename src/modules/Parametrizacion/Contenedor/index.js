...
import ContenedorCreador from './ContenedorCreador';
import {
  onGetColeccion,
  onDelete,
...
const cells = [
  ...
  // },
  {
    id: 'indicativo_contenedor_reparacion',
    typeHead: 'string',
    label: 'En Reparación',
...
const Contenedor = (props) => {
  ...
  const onOpenViewContenedor = (id) => {
    setContenedorSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteContenedor = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El Contenedor?',
  ...
  const onOpenAddContenedor = () => {
    setContenedorSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
      ...
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddContenedor={onOpenAddContenedor}
