...
const Usuarios = (props) => {
  ...
  useEffect(() => {
    dispatch(onGetColeccion(page, rowsPerPage, nombre, cliente, orderByToSend));
  }, [dispatch, page, rowsPerPage, debouncedName, orderByToSend, cliente]); // eslint-disable-line react-hooks/exhaustive-deps
                    ...
                    return (
                      <TableRow
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          ...
                          {permisos.indexOf('Clave') >= 0 && ['IN', 'AC'].includes(user?.rol?.tipo??'') && (
