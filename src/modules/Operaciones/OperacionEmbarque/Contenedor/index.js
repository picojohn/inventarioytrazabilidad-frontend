...
import ContenedorEmbarqueCreador from './ContenedorCreador';
import {
  onGetColeccion,
  onDelete,
...
const cells = [
  ...
  },
  {
    ...
    typeHead: 'string',
    label: 'Estado',
    value: (value) => ESTADOS_CONTENEDORES_OPERACION_EMBARQUE.map((state) => state.id === value ? state.nombre : ''),
    align: 'left',
    mostrarInicio: true,
  },
  {
      ...
      className={clsx(classes.root)}>
        <>
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              <Tooltip
                ...
                onClick={onOpenAddContenedorEmbarque}>
                <IconButton
          ...
          <Box className={classes.contenedorFiltros}>
            <TextField
              label='Operación Embarque'
              name='operacionEmbarque'
              id='operacionEmbarque'
              disabled
              value={operacionEmbarque?.nombre??''}
...
const ContenedorEmbarque = (props) => {
  const {
    showForm: show,
    operacionEmbarque,
    handleOnClose: close,
  ...
  const [contenedorEmbarqueSeleccionado, setContenedorEmbarqueSeleccionado] =
    useState(0);
  ...
  useEffect(() => {
    if(operacionEmbarque){
      dispatch(onGetColeccion(page, rowsPerPage, operacionEmbarque.id ,nombre, orderByToSend));
    }
  }, [page, rowsPerPage, debouncedName, orderByToSend, operacionEmbarque]); //eslint-disable-line
  ...
  const onOpenEditContenedorEmbarque = (id) => {
    setContenedorEmbarqueSeleccionado(id);
    setAccion('editar');
    setShowForm({
      ...initialShow,
      creador: true
  ...
  const onOpenViewContenedorEmbarque = (id) => {
    setContenedorEmbarqueSeleccionado(id);
    setAccion('ver');
    setShowForm({
      ...initialShow,
  ...
  const onDeleteContenedorEmbarque = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Quitar el Contenedor de la Operación de Embarque?',
  ...
  const onOpenAddContenedorEmbarque = () => {
    setContenedorEmbarqueSeleccionado(0);
    setAccion('crear');
    setShowForm({
      ...initialShow,
      creador: true
        ...
        <div className={classes.root}>
          <Paper className={classes.paper}>
            <EnhancedTableToolbar
              onOpenAddContenedorEmbarque={onOpenAddContenedorEmbarque}
                            ...
                            <TableRow
                              ...
                              >
                                <Tooltip
                                  ...
                                  <Edit
                                    onClick={() =>
                                      onOpenEditContenedorEmbarque(row.id)
                                    }
                                ...
                                <Tooltip title={<IntlMessages id='boton.ver' />}>
                                  <Visibility
                                    onClick={() =>
                                      onOpenViewContenedorEmbarque(row.id)
                                    }
                                ...
                                <Tooltip
                                  ...
                                  <Delete
                                    onClick={() =>
                                      onDeleteContenedorEmbarque(row.id)
                                    }
          ...
          {showForm.creador ? (
            <ContenedorEmbarqueCreador
              showForm={showForm.creador}
              contenedorEmbarque={contenedorEmbarqueSeleccionado}
              operacionEmbarque={operacionEmbarque}
              accion={accion}
...
export default ContenedorEmbarque;
