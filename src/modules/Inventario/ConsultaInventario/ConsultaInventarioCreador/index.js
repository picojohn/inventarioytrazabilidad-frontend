...
import ConsultaInventarioForm from './ConsultaInventarioForm';
...
const ConsultaInventarioCreador = (props) => {
  ...
  //     dispatch(onShow(consultaInventario));
  //   }
  // }, [accion, dispatch, consultaInventario]);
        ...
        <Scrollbar>
          <Formik
            ...
            initialValues={{
              ...
              // stock_minimo: consultaInventario ? consultaInventario.stock_minimo?consultaInventario.stock_minimo:'': '',
