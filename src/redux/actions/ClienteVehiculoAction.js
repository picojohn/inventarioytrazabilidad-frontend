         ...
         .then(
            (data) => {
               if (data.status === 200) {
                  ...
                  dispatch({
                     type: GET_HEADERS_CLIENTE_VEHICULO, 
                     payload: data
                  });
               } 
               else 
         ...
         .then (
            (data) => { 
               if (data.status === 200) {                      
                  ...
                  dispatch({ 
                     type: GET_COLECCION_CLIENTE_VEHICULO, 
                     payload: data 
                  });
               } 
               else 
...
export const onGetColeccionLigera = (cliente_id) => {
   ...
   return (dispatch) => {
      ...
      jwtAxios.get('clientes-vehiculos/'+cliente_id, { 
         params: { 
            ligera: true,
         }})
      .then ((data) => { 
         if (data.status === 200) {                      
            ...
            dispatch({type: GET_COLECCION_LIGERA_CLIENTE_VEHICULO, payload: data});
         } else {
...
export const onShow = (
   ...
   return (dispatch) => {
      if (id !== 0) {
         ...
         jwtAxios
            .get (
               'clientes-vehiculos/' + cliente_id + '/' + id
            )
            .then (
               (data) => { 
                  if (data.status === 200) {
...
export const onCreate = (
   ...
   return (dispatch) => {
      ...
      jwtAxios
         .post (
            'clientes-vehiculos/' + params.cliente_id, 
            params
         )
         .then (
            (data) => { 
...
export const onUpdate = (
   ...
   return (dispatch) => {
      ...
      jwtAxios
         .put (
            'clientes-vehiculos/' + params.cliente_id + '/' + params.id, 
            params
         )
         .then (
            (data) => { 
