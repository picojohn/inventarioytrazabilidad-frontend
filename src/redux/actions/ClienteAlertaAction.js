         ...
         .then(
            (data) => {
               if (data.status === 200) {
                  ...
                  dispatch({
                     type: GET_HEADERS_CLIENTE_ALERTA, 
                     payload: data
                  });
               } 
               else 
         ...
         .then (
            (data) => { 
               if (data.status === 200) {                      
                  ...
                  dispatch({ 
                     type: GET_COLECCION_CLIENTE_ALERTA, 
                     payload: data 
                  });
               } 
               else 
         ...
         .then (
            (data) => { 
               if (data.status === 200) {                      
                  ...
                  dispatch({ 
                     type: GET_COLECCION_LIGERA_CLIENTE_ALERTA, 
                     payload: data 
                  });
               } 
               else 
...
export const onShow = (
   ...
   return (dispatch) => {
      if (id !== 0) {
         ...
         jwtAxios
            .get (
               'clientes-alertas/' + cliente_id + '/' + id
            )
            .then (
               (data) => { 
                  if (data.status === 200) {
...
export const onCreate = (
   ...
   return (dispatch) => {
      ...
      jwtAxios
         .post (
            'clientes-alertas/' + params.cliente_id, 
            params
         )
         .then (
            (data) => { 
...
export const onUpdate = (
   ...
   return (dispatch) => {
      ...
      jwtAxios
         .put (
            'clientes-alertas/' + params.cliente_id + '/' + params.id, 
            params
         )
         .then (
            (data) => { 
