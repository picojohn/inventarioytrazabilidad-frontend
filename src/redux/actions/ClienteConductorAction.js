...
export const onGetHeaders = (
   ...
   return (dispatch) => {
      ...
      jwtAxios
         .get(
            'clientes-conductores/' + cliente_id, 
            {  params: 
               {
                  headerInfo: true,
               },
         ...
         .then(
            (data) => {
               if (data.status === 200) {
                  ...
                  dispatch({
                     type: GET_HEADERS_CLIENTE_CONDUCTOR, 
                     payload: data
                  });
               } 
               else 
         ...
         .then (
            (data) => { 
               if (data.status === 200) {                      
                  ...
                  dispatch({ 
                     type: GET_COLECCION_CLIENTE_CONDUCTOR, 
                     payload: data 
                  });
               } 
               else 
         ...
         .then (
            (data) => { 
               if (data.status === 200) {                      
                  ...
                  dispatch({ 
                     type: GET_COLECCION_LIGERA_CLIENTE_CONDUCTOR, 
                     payload: data 
                  });
               } 
               else 
...
export const onShow = (
   ...
   return (dispatch) => {
      if (id !== 0) {
         ...
         jwtAxios
            .get (
               'clientes-conductores/' + cliente_id + '/' + id
            )
            .then (
               (data) => { 
                  if (data.status === 200) {
...
export const onCreate = (
   ...
   return (dispatch) => {
      ...
      jwtAxios
         .post (
            'clientes-conductores/' + params.cliente_id, 
            params
         )
         .then (
            (data) => { 
...
export const onUpdate = (
   ...
   return (dispatch) => {
      ...
      jwtAxios
         .put (
            'clientes-conductores/' + params.cliente_id + '/' + params.id, 
            params
         )
         .then (
            (data) => { 
